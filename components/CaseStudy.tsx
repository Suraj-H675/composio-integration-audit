  ...
  return <main className="case-study">
    ...
    <section className="hero section-shell" id="top">
      <div className="hero-copy">
        <h1>{data.dataset.appCount} integrations researched.<br /><span>Distribution is the bottleneck.</span></h1>
        <p className="hero-lede">Most integrations are technically possible. The harder question is whether they can be shipped to everyone.</p>
        ...
        <div className="hero-actions"><a className="button primary" href="#explore">Explore the {data.dataset.appCount} apps</a><a className="button text-button" href="#method">See the verification</a></div>
      </div>
      <div className="hero-aside">
        <div className="aside-kicker">HOW TO READ THE AUDIT</div>
        <div className="lens-row"><strong>Can it be built?</strong><small>Technical surface</small></div>
        <div className="lens-row active"><strong>Can it be distributed?</strong><small>Access + approval</small></div>
        <div className="lens-row"><strong>Can we prove it?</strong><small>Evidence + review</small></div>
    ...
    <section className="section-shell insight-section" id="insight">
      ...
      <div className="insight-callout"><span className="callout-mark">!</span><p><strong>{metrics.distribution.customerEasyDistributionGated.numerator} apps look self-service from the customer's side</strong> but still gate public distribution. Route those to Partnerships, not an engineering backlog.</p></div>
    ...
    <section className="section-shell category-section" id="categories">
      <div className="section-intro split-intro"><div><SectionLabel index="05">Across the categories</SectionLabel><h2>Patterns by<br /><i>category.</i></h2></div><p>Technical feasibility is broadest in developer tools and productivity. Commerce and AI/media show more access uncertainty and distribution friction.</p></div>
